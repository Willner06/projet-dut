...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    {{-- <div class="d-flex align-items-center justify-content-between">
      <a href="{{route('home')}}" class="logo d-flex align-items-center">
        ...
        <form action="{{route('user.logout')}}" class="logo d-flex align-items-center" method="post">
            @csrf
            <a  href="#">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      {{-- <li class="nav-item">
        <a class="nav-link " href="{{route('caisse.home')}}">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('caisse.home')}}">
          <i class="bi bi-graph-up-arrow"></i>
          <span>Tableau de bord suivi de caisse</span>
        </a>
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{route('caisse.encaissement.index')}}">
              <i class="bi bi-circle"></i><span>Encaissement</span>
            </a>
          </li>
          <li>
            <a href="{{route('caisse.decaissement.index')}}">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#cloture" data-bs-toggle="collapse" href="#">
            <i class="bi bi-wallet-fill"></i><span>Clôture de caisse</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="cloture" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <li>
                <a class="nav-link collapsed" href="{{route('caisse.clotureDeCaisse')}}">
                    <i class="bi bi-circle"></i>
                    <span>Fiche de clôture</span>
                </a>
            <li>
            <li>
                <a class="nav-link collapsed" href="{{route('caisse.inventaire')}}">
                    <i class="bi bi-circle
                    "></i><span>Inventaire de caisse</span>
                </a>
        </li>
        </ul>
      </li><!-- End Components Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#etat" data-bs-toggle="collapse" href="#">
            <i class="bi bi-wallet"></i><span>Etats centralisés</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="etat" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <li>
                <a class="nav-link collapsed" href="{{route('caisse.decaissement.transport')}}">
                  <i class="bi bi-circle"></i>
                  <span>Fiche de transport</span>
                </a>
            </li>
            <li>
                <a class="nav-link collapsed" href="{{route('caisse.decaissement.communication')}}">
                    <i class="bi bi-circle"></i>
                    <span>Fiche de communication</span>
                  </a>
            </li>
            <li>
                <a class="nav-link collapsed" href="{{route('caisse.decaissement.carburant')}}">
                  <i class="bi bi-circle"></i>
                  <span>Fiche carburant</span>
                </a>
            </li>
            <li>
                <a class="nav-link collapsed" href="{{route('caisse.decaissement.autre')}}">
                  <i class="bi bi-circle"></i>
                  <span>Autres décaissements</span>
                </a>
            </li><!-- End Profile Page Nav -->
        </ul>
      </li><!-- End Components Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('caisse.suivi.index')}}">
          <i class="bi bi-table"></i><span>Tableur de suivi de caisse</span>
        </a>
      </li>
      ...
      {{-- <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('caisse.inventaire')}}">
          ...
          "></i><span>Inventaire de la caisse</span>
        </a>
      </li> --}}

...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('tiers.indexFournisseur')}}">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('tiers.indexClient')}}">
          <span>Clients</span>
        </a>
      </li><!-- End Contact Page Nav -->

      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('tiers.indexAutre')}}">

          <span>Autre tiers</span>
        </a>
      </li>
  ...
  <main id="main" class="main">
    {{-- <div class="pagetitle d-inline">
        ...
        <div class="float-end">
            <button class="btn btn-success">Encaissement</button>
            <button type="button" class="btn btn-warning">Décaissement</button>
        </div>
      </div><!-- End Page Title --> --}}

...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      {{-- @can('Voir le tableau de bord des tiers') --}}
      {{-- <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('tiers.home')}}">
          <i class="bi bi-person-lines-fill"></i>
          <span>Tableau de bord suivi des tiers</span>
        </a>
      </li><!-- End Profile Page Nav --> --}}

      {{-- @endcan --}}

      {{-- @can('Gerer les employés') --}}
      ...
      @can('Acceder à l\'historique de connexion')
      <li class="nav-item">
    ...
    @can('Gerer les utilisateurs')
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#utilisateurs" data-bs-toggle="collapse" href="#">
          <i class="bi bi-people-fill"></i><span>Gestion des utilisateurs</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>

...
@section('content')
        ...
        <div class="pagetitle">
            <div class="">
                ...
                <div class="card float-end">
                    <button class="badge text-bg-success m-3" type="button" data-bs-toggle="modal" data-bs-target="#addProduit"> <i class="bi bi-plus-lg"></i> Produit </button>
                </div>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('marchandise.categorie.index') }}">Catégories</a></li>
    ...
    <div class="modal fade" id="addProduit" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
            ...
            <div class="modal-body">
                <form class="row g-3 needs-validation" novalidate method="post" action="{{route('marchandise.store')}}">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="number" class="form-control" id="prix_unitaire" name="prix_unitaire" min="1" required>
                    </div>
                    <div class="col-12">
